...
<!-- Tombol untuk tambah produk terjual baru dan ekspor -->
        ...
        @endif
<!-- Form pop-up untuk tambah produk terjual baru -->
        <div class="popup">
...
<!-- Input untuk filter berdasarkan rentang tanggal -->
 ...
 <!-- Bagian tabel untuk menampilkan produk terjual -->
 ...
 <!-- JavaScript untuk menangani fitur pencarian, pengurutan, dan filter -->
        <script>
