    ...
    <div>
      <div>
        <aside class="sidebar">
          ...
          <ul class="sidebar-links">
            ...
            <li>
              <a href="{{ route('sold') }}"
                ><span class="material-symbols-outlined"> flag </span>Sold
                item</a
              >
            </li>
            <li>
      ...
      <div class="profile-button">
        <nav class="nav-profile">
          ...
          <img
            src="{{ asset('image/profile-img.jpg') }}"
            class="profile-logo"
            onclick="toggleMenu()"
            style="width: 30px; height: 30px"
          />
          <div class="sub-menu-wrap" id="submenu">
            <div class="sub-menu">
              ...
              <a href="#" class="sub-menu-link" style=" height: 24px">
                <i
                  class="fa-solid fa-arrow-right-from-bracket sub-menu-link-img"
                ></i>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <p :href="route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();" style="color: white; margin-bottom: 0">
                        {{ __('Log Out') }}
                    </p>
                </form>
              </a>
