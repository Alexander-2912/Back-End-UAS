...
<!-- Form untuk menambahkan pembelian baru -->
                    ...
                    <tbody>
                        @foreach ($purchases as $item)
                            <tr>
                                ...
                                <td>{{ $item->date }}</td>
                                <td>
                                    <!-- Tombol untuk mengedit data pembelian -->
                                    <a href="{{ route('purchase.edit', ['purchase' => $item]) }}"
                                        class="btn btn-primary">Edit</a>
                                        <!-- Form untuk menghapus data pembelian -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Menangani dropdown penyortiran
            ...
            // Fungsi untuk memfilter tabel berdasarkan keyword
            ...
            // Fungsi untuk menyortir tabel berdasarkan kriteria yang dipilih
            ...
            function filterByDate() {
                ...
                let rows = document.querySelectorAll('tbody tr');
                rows.forEach(row => {
                    let rowDate = new Date(row.cells[7].innerText);
